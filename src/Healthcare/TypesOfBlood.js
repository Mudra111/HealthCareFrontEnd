...
export const TypesOfBlood = () => {
  return (
    <div>
      ...
      <div>
        <div className="tobd">
          <img src={WholeBlood} alt="" className="bd1" />
          <div className="con1">
            <h2 className="title">Whole Blood Donation</h2>
            <h4>What is it?</h4>
            <p className="tobd-con">
              “Whole blood” is simply the blood that flows through your veins.
              It contains red cells, white cells, and platelets, suspended in
              plasma.
            </p>
            <h4>Who it helps</h4>
            <p className="tobd-con">
              Whole blood is frequently given to trauma patients and people
              undergoing surgery.
            </p>
            <h4>Time it takes</h4>
      ...
      <div>
        <div className="tobd">
          ...
          <div className="con1">
            ...
            <h4>Who it helps</h4>
            <p className="tobd-con">
              Platelets are a vital element of cancer treatments and organ
              transplant procedures, as well as other surgical procedures.
            </p>
            <h4>Time it takes</h4>
            <p className="tobd-con">About 2.5-3 hours</p>
            <h4>Ideal blood types</h4>
            <p className="tobd-con">
              A positive, A negative, B positive, O positive, AB positive and AB
              negative
            </p>
            <h4>Donation frequency</h4>
      ...
      <div>
        <div className="tobd">
          ...
          <div className="con1">
            ...
            <h4>Who it helps</h4>
            <p className="tobd-con">
              AB Plasma is used in emergency and trauma situations to help stop
              bleeding.{" "}
            </p>
            <h4>Time it takes</h4>
        ...
        <div className="tobd">
          ...
          <div className="con1">
            ...
            <p className="tobd-con">
              ...
              machine is used to allow you to safely donate two units of red
              blood cells during one donation while returning your plasma and
              platelets to you.
            </p>
            <h4>Who it helps</h4>
            <p className="tobd-con">
              Red cells from a Power Red donation are typically given to trauma
              patients, newborns and emergency transfusions during birth, people
              with sickle cell anemia, and anyone suffering blood loss.
            </p>
            <h4>Time it takes</h4>
