...
export const DonationPro = () => {
    return <div>
        <h1 style={{textAlign:'center',}}>The Blood Donation Process</h1>
        <h5 style={{textAlign:'center',}}>The blood donation process from the time you arrive until the time you leave takes about an hour. The donation itself is only about 8-10 minutes on average.</h5>

        <div className='bg'>
            <h1 className='title1'>Registration</h1>
            <div className="d-flex dpo">
        ...
        <div className='bg bg1'>
            ...
            <div className="d-flex dpo">
                <img src={HealthHistory} alt="" className='bd2' style={{marginTop:'1rem',marginBottom:'1rem',}} />
                <div className='con1'>
                    <ul className='con2'>
        ...
        <div className='bg'>
            ...
            <div className="d-flex dpo">
                <img src={YourDonation} alt="" className='bd2' style={{width:'40%',}}/>
                <div className='con1'>
        ...
        <div className='bg bg1' style={{ marginBottom: '2rem', }}>
            ...
            <div className="d-flex dpo">
                <img src={ThankYou} alt="" className='bd2' style={{marginTop:'1rem',marginBottom:'1rem',}} />
                <div className='con1'>
                    <ul className='con2'>
